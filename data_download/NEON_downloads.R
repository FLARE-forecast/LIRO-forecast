...
download_neon_files <- function(siteID_neon, siteID, products, buoy_products, site_tower){
        ...
        # Precipitation
        precip  <- neonstore::neon_table(table = "SECPRE_30min-basic", site = site_tower) %>%
        ...
        write_csv(d, "./qaqc_data/observations_postQAQC_long.csv")
